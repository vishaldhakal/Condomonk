...
export async function getStaticProps() {
  const posts4 = await axios.get(
    `https://api.homebaba.ca/api/pre-constructions-city/ontario-pre-construction-sales-and-assignment-sale/?perpage=5`
  );
  const posts = await axios.get(
    `https://api.homebaba.ca/api/pre-constructions-city/mississauga/?perpage=5`
  );
  const posts2 = await axios.get(
    `https://api.homebaba.ca/api/pre-constructions-city/toronto/?perpage=5`
  );
  const posts3 = await axios.get(
    `https://api.homebaba.ca/api/pre-constructions-city/oakville/?perpage=5`
  );
  return {
    props: {
