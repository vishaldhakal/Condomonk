...
export default function MyListings(props) {
  ...
  function retImg() {
    if (props.images[0]) {
      return "https://api.homebaba.ca" + props.images[0].images;
    } else {
    ...
    <>
      <Head>
        ...
        {props.images[0] && (
          <meta
            property="og:image"
            content={`https://api.homebaba.ca${props.images[0].images}`}
          />
        )}
        {!props.images[0] && (
          <meta
              ...
              <div className="my-3 grid-cont">
                <SRLWrapper options={options}>
                  {myimages?.slice(0, 6).map((image, no) => (
                    ...
                    >
                      <img
                        src={`https://api.homebaba.ca${image.images}`}
                      ...
                      <div className="row me-0 row-cols-1 row-cols-md-2 row-cols-lg-3 py-1 gy-5">
                        ...
                        <div className="col rounded-mine">
                          {/* <div className="mybox">
                            ...
                            <span>
                              {props.house_detail.development_charges}
                            </span>
                          </div> */}
                        </div>
                      </div>
...
export async function getStaticProps({ params }) {
  const posts = await axios.get(
    `https://api.homebaba.ca/api/pre-constructions/${params.listing_id}/`
  );
